...
<script lang="ts">
    ...
    /**
     * Move the icon a little bit up, default - no
     */
    ...
    */
    ...
    $: type = icon in GLYPHTER_ICONS ? "glyphter"
        ...
        : "";
    $: if (!type) console.error("Unknown icon", icon);
...
<!-- maybe optionally wrap into Clickable for correct a11y? -->
<!-- svelte-ignore a11y-click-events-have-key-events -->
<span
    class={type} class:upper
    style:--color={color}
    use:tip={hint}
    on:click
>{symbol}</span>
...
<style>
    ...
    /* version without background bc it matches the target one */
    .best-streak {
        background-image: url('data:image/svg+xml,%3csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 21"%3e%3cpath fill="%23F89020" d="M7.8 0c.2 2.4-.9 4-1.7 5.3h2.2v1.6h3.3V5.7l.3-.4h2.8A7.3 7.3 0 0 0 12 2.8a3 3 0 0 1-1 3.5c.1-2-.7-5-3.2-6.3Z"/%3e%3cpath fill="none" stroke="%23FFBF25" stroke-linecap="square" stroke-width="2" d="M16.4 9v10H3.6V9m2.8-1.7V10m7.2-2.7V10M9.2 9h1.6"/%3e%3c/svg%3e');
    }
    .carat {
    ...
    .RE {
        background-image: url('/img/icon/icon-RE.svg');
    }
    .LE {
        background-image: url('/img/icon/icon-LE.svg');
    }
    .backToCollection {
        background-image: url('data:image/svg+xml,%3csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 7"%3e%3cpath fill="white" d="M0 0v3h3V0H0l1 1h1v1H1V1zM0 4v3h3V4H0l1 1h1v1H1V5zM3.5 3.5 5 2v1h2v1H5v1z"/%3e%3c/svg%3e');
    }
    .share, .share-white {
        background-image: url('data:image/svg+xml,%3csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 26"%3e%3cpath d="M3 24h11c2 0 3-1 3-3V11c0-2-1-3-3-3H3c-2 0-3 1-3 3v10c0 2 1 3 3 3Zm-1-4v-9l1-2h11l2 2v9l-2 2H3l-1-2Z"/%3e%3cpath fill="white" d="M11 15V3a3 3 0 0 0-5 0v12c0 2 1 3 3 3 1 0 2-1 2-3Z"/%3e%3cpath d="M9 16V4h1l2 2 1-1-4-3V1L8 2 5 5v1h1l1-2h1v11l1 1Z"/%3e%3c/svg%3e');
    }
    .share-white {
        filter: invert(1);
    }
    .switchSeries {
        background-image: url('data:image/svg+xml,%3csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 7 7"%3e%3cpath fill="white" d="M0 0v3h3V0H0l1 1h1v1H1V1zM4 4v3h3V4H4l1 1h1v1H5V5zM1 4v2h2V5H2V4zM4 1h2v2H5V2H4z"/%3e%3c/svg%3e');
    }
    .reward-star {
        background-image: url('/img/icon/reward-toggle.svg');
    }

    /* icons not from NeonMob */
